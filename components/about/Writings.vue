<template>
    <svg xmlns="http://www.w3.org/2000/svg" class="inline-block" width="24" height="24" viewBox="0 0 36 36">
        <path fill="#CCD6DD" d="M31 32a4 4 0 0 1-4 4H5a4 4 0 0 1-4-4V4a4 4 0 0 1 4-4h22a4 4 0 0 1 4 4v28z" />
        <path fill="#99AAB5"
        ...
        <path fill="#FFCC4D" d="m11.849 17.815l3.17 3.17l3.165 3.166l11.881-11.879l-6.337-6.336l-11.879 11.879z" />
        <path fill="#292F33"
            d="M11.298 26.742s-2.06 1.133-2.616.576c-.557-.558.581-2.611.581-2.611s1.951.036 2.035 2.035z" />
        <path fill="#CCD6DD" d="m23.728 5.935l3.96-3.96l6.336 6.337l-3.96 3.96z" />
        <path fill="#99AAB5"
